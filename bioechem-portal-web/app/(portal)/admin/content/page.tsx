...
import { CalendarDays, FileText, Gift, Images } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="grid items-stretch gap-4 sm:grid-cols-2">
        <Link href="/admin/content/newsletters" className="group block h-full">
          <PortalCard className="h-full transition-shadow hover:shadow-md">
        ...
        <Link href="/admin/content/upcoming-events" className="group block h-full">
          <PortalCard className="h-full transition-shadow hover:shadow-md">
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-bio-green/10">
        ...
        <Link href="/admin/content/past-events" className="group block h-full">
          <PortalCard className="h-full transition-shadow hover:shadow-md">
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-bio-green/10">
        ...
        <Link href="/credits" className="group block h-full">
          <PortalCard className="h-full transition-shadow hover:shadow-md">
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-bio-green/10">
                <Gift className="h-5 w-5 text-bio-green" />
              </div>
              <div>
                <h2 className="font-semibold text-bio-text group-hover:text-bio-green">Credits Info</h2>
                <p className="mt-1 text-sm text-bio-text-muted">
                  View the Credits page, with an edit option for the intro, actions, and claim instructions.
                </p>
              </div>
            </div>
          </PortalCard>
